...
export const reducers = combineReducers({
  ...
  authors: require('../../modules/entities/author/author.reducer').reducer,
  books: require('../../modules/entities/book/book.reducer').reducer,
  customers: require('../../modules/entities/customer/customer.reducer').reducer,
  purchases: require('../../modules/entities/purchase/purchase.reducer').reducer,
